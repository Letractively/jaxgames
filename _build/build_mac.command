...
echo "==============================================================================="
echo "jaxgames build process                                                   v0.4.0"
echo "==============================================================================="
...
# --exclude '/_*' = exlcude files/folders beginning with underscore, only on the root. there are a number of javascript/css
#                   files starting with underscore that will be merged into one, and then later removed.
