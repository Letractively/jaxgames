 ...
 *
 * Usage: ./packer.js infile.js [infile2.js] [infile3.js] [...] outfile.js
 *
 ...
 *
 * Modifications to allow multiple files to be combined before packing
 * by Kroc Camen <kroccamen@gmail.com>
 *
...
function main () {
        if (argv.length < 2) {
                ...
                ;
                print ("  finished! ("+elapsed+"s "+codeComp.length+"b -"+(100-Math.floor((codeComp.length/total)*100))+"%)");
        }
}
