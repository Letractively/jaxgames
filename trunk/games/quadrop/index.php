	...
	<div id="shared-gamearea">
		...
		<div id="player-status-me" class="player-status" style="display:none;">
		        <div id="player-status-me-info" class="player-info">
		                <div id="player-status-me-win">Wins: <span id="player-status-me-wins">0</span> <img src="../-/imgicons/award_star_gold_1.png" width="16" height="16" align="top" alt="Wins" /></div>
